...
/***/ "./node_modules/html5-sortable/sortable.js":
...
var sortable = __webpack_require__("./node_modules/html5-sortable/sortable.js");
...
$(document).ready(function () {
	function bindSortable() {
		...
		var destroy = sortable({
			...
			onDragEnd: function onDragEnd(e) {
				resetModel($(e.target).parent('.sortable'));
			}
		});
	...
	$('[e-filltext]').on('click.filltext', function () {
		$('#' + $(this).attr('e-filltext')).focus().val($(this).text()).addClass('mdl-textfield__input is-dirty').parents('.mdl-textfield').addClass('is-dirty');
	});

	$('[e-select-timezone]').on('click.timezone', function () {
		$('#' + $(this).attr('e-select-timezone')).val($(this).text()).addClass('mdl-textfield__input is-dirty').parents('.mdl-textfield').addClass('is-dirty');
	});
